...
const INPUT_CLS = 'w-full bg-[#F4F4F4] dark:bg-zinc-900 border-transparent rounded-[16px] py-2.5 px-4 outline-none focus:ring-4 focus:ring-blue-500/5 focus:border-blue-500 transition-all text-sm font-semibold text-zinc-900 dark:text-zinc-100 h-12';
