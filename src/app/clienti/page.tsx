      ...
      <div className="pt-2 px-4 md:px-6 pb-1 max-w-4xl mx-auto w-full flex-shrink-0">
        <header className="mb-2 flex items-end justify-between">
          ...
          <button
            ...
            title="Nuovo Cliente"
            className="bg-pink-500 p-3 rounded-2xl text-white shadow-lg shadow-pink-500/20 hover:scale-105 active:scale-95 transition-all shadow-pink-500/10"
          >
            <Plus size={24} />
          </button>
        </header>
        ...
        <div className="relative group">
          <Search
            className="absolute left-4 top-1/2 -translate-y-1/2 text-zinc-400 group-focus-within:text-pink-500 transition-colors"
            size={20}
          />
          <input
            type="text"
          ...
          {loading ? (
            ...
            <div className="bg-white dark:bg-zinc-900/50 border border-zinc-200 dark:border-zinc-800 rounded-[32px] p-16 text-center shadow-sm">
              ...
              {!search && (
                <button 
                  onClick={() => setIsModalOpen(true)}
                  className="mt-4 text-pink-500 font-black text-xs uppercase tracking-widest hover:underline"
                >
                  ...
                  <div className="flex items-center gap-4 min-w-0 w-full sm:w-auto">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="flex items-center flex-wrap gap-x-3 gap-y-1.5 mt-1.5">
                        ...
                        {patenteDisplay && (
                          <span className="px-2 py-0.5 bg-pink-50 dark:bg-pink-500/10 text-pink-600 dark:text-pink-400 rounded-md text-[10px] font-black uppercase tracking-wider">
                            Pat. {patenteDisplay}
                          </span>
                        )}
                      </div>
