      ...
      <nav className="fixed bottom-[calc(1.5rem+env(safe-area-inset-bottom,0px))] left-1/2 -translate-x-1/2 w-[95%] max-w-2xl z-50 animate-in fade-in slide-in-from-bottom-4 duration-500">
        <div className="bg-white/90 dark:bg-zinc-900/90 backdrop-blur-xl flex items-center justify-between py-2 px-3 sm:px-6 rounded-[32px] shadow-[0_20px_50px_rgba(0,0,0,0.1)] dark:shadow-[0_20px_50px_rgba(0,0,0,0.3)] border border-zinc-200/50 dark:border-zinc-800/50">
          ...
          <div className="flex items-center gap-2 px-2 min-w-0 max-w-[100px] sm:max-w-[150px]">
            <div className="w-8 h-8 rounded-full bg-sky-100 dark:bg-sky-900/30 text-sky-600 dark:text-sky-400 flex items-center justify-center shrink-0 shadow-inner">
              ...
              if (item.isMain) {
                return (
                  <button
                    ...
                    title={item.name}
                    className="bg-sky-500 hover:bg-sky-400 text-white p-3 sm:p-3.5 rounded-2xl -mt-10 sm:-mt-12 shadow-lg shadow-sky-500/40 transition-all duration-300 hover:scale-110 active:scale-95 cursor-pointer outline-none ring-offset-2 focus:ring-2 focus:ring-sky-500"
                  >
