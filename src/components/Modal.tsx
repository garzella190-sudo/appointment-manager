...
export const Modal = ({ isOpen, onClose, title, children }: ModalProps) => {
  ...
  const modalContent = (
    <div className={cn(
      ...
      {/* Modal Panel - Proportional Sizing & Robust Centering with my-auto */}
      <div 
        className={cn(
      ...
      >
        ...
        <div className="flex items-center justify-between p-6 sm:p-7 border-b border-zinc-100 dark:border-zinc-800 shrink-0">
          ...
          <button 
            onClick={onClose}
            className="p-2.5 text-zinc-400 hover:text-zinc-600 dark:hover:text-zinc-300 bg-zinc-50 hover:bg-zinc-100 dark:bg-zinc-800/50 dark:hover:bg-zinc-800 rounded-2xl transition-all hover:rotate-90 appearance-none"
          >
            <X size={22} />
